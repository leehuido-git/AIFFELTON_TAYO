...
def pspunet_vgg16(input_shape=(224,224,3)):
    vgg_model = vgg16(input_shape)
    vgg_model.load_weights(os.path.join(os.getcwd(), 'models', 'vgg16.h5'))
    ...
    return tf.keras.Model(inputs = input , outputs = x) , 'pspunet_vgg16'